...
- 🎯 Entry points to execute your program using `python -m <my_river>` or `$ my_river` with basic CLI argument parsing.
...
```bash
pip install my_river
```

## Usage

```py
from my_river import BaseClass
from my_river import base_function
